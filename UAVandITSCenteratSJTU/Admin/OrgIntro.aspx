<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrgIntro.aspx.cs" Inherits="Admin_OrgIntro" %>
                        ...
                        <div id="GridViewShow"> 
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="组织简介" SortExpression="OrgIntro">
                                        <ItemTemplate>
                                          <%--  <asp:Label ID="Label1" runat="server" Text='<%# ShortString2(Eval("OrgIntro").ToString()) %>'></asp:Label>--%>
                                             <%# ShortString2(Eval("OrgIntro").ToString()) %>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# ShortString2(Eval("OrgIntro").ToString()) %>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
