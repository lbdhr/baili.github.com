<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsReleaseManageAdmin.aspx.cs"
                    ...
                    <td style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; padding-top: 10px;
                        ...
                        <div id="GridViewShow"> 
                            ...
                            <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT * FROM [News] where ((NewsWriter='研究所动态' or NewsWriter='课题组通知' or NewsWriter='业内新闻' or NewsWriter='夏令营消息')) ORDER BY [ID] DESC ,[NewsIsTop] ASC,[NewsIsRed] ASC" 
                                ...
                                <SelectParameters>
                                    <asp:SessionParameter DefaultValue="学生会" Name="NewsWriter" 
                                        SessionField="AdminOrg" Type="String" />
                                </SelectParameters>
                                <UpdateParameters>
                                    <asp:Parameter Name="NewsTitle" Type="String" />
                                    <asp:Parameter Name="NewsWriter" Type="String" />
