<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsReleaseAdmin.aspx.cs" Inherits="Admin_NewsRelease" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                                            DataSourceID="AccessDataSource1" DataTextField="SonNav" 
                                            DataValueField="SonNav" Width="100px">
                                        </asp:DropDownList>
                                        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                                            DataFile="~/App_Data/OrgData.mdb" 
                                            SelectCommand="SELECT * FROM [NavDetail] WHERE ([FatherID] = ?)">
                                            <SelectParameters>
                                                <asp:QueryStringParameter DefaultValue="2" Name="FatherID" 
                                                    QueryStringField="fatherid" Type="Int32" />
                                            </SelectParameters>
