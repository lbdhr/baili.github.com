...
<body style="background-position-y: -120px; background-image: url(images/bg.gif);
    ...
    <div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label 
            ID="lblName" runat="server" Width="200px"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
            ControlToValidate="txtRPwd" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
        <asp:CompareValidator ID="CompareValidator1" runat="server" 
            ControlToCompare="txtPwd" ControlToValidate="txtRPwd" ErrorMessage="密码不同！" 
