<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsReleaseManage.aspx.cs"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; padding-top: 10px;
                        ...
                        <div id="GridViewShow"> 
                            <asp:LinkButton ID="LinkButton4" runat="server">添加信息</asp:LinkButton>
                            ...
                            <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                                ...
                                <SelectParameters>
                                    <asp:SessionParameter DefaultValue="学术论文" Name="NewsWriter" 
