...
public partial class Admin_NewsRelease : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                this.DropDownList1.Text = SqlHelper.FindString(" SELECT NewsWriter FROM [News] WHERE [ID]="+newsid.ToString());
            }
            catch
            { }
        }
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        ...
        string newswriter = this.DropDownList1.Text.ToString();
        ...
        try
        {
            ...
            else
            {
                ...
                string ss = "<script language=javaScript>alert('发布成功！');window.location='NewsReleaseManageAdmin.aspx';</script>";
                Response.Write(ss);
            }
