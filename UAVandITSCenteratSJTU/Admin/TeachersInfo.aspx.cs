...
public partial class Admin_TeachersInfo : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        ...
        try
        {
            string insertcmd = "INSERT INTO [TeachersInfo](TName,TSex,TBirth,TNation,TZhiwu,TDanwei,TTel,TEmail,TInfo,TPicUrl) VALUES ('"
                + tname.ToString() + "','" + tsex.ToString() + "','" + tbirth.ToString() + "','" + tnation.ToString() + "','" + tzhiwu.ToString() + "','" + tdanwei.ToString() + "','" + ttel.ToString() + "','" + temail.ToString() + "','" + tinfo.ToString() + "','" + newspicrul.ToString() + "')";
            ...
            else
            {
                ...
                string ss = "<script language=javaScript>alert('添加成功！');window.location='TeachersInfoManage.aspx';</script>";
                Response.Write(ss);
            }
