<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrgNumbers.aspx.cs" Inherits="Admin_OrgNumbers" %>
                        ...
                        <div id="GridViewShow"> 
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="组织结构" SortExpression="OrgNumbers">
                                        <ItemTemplate>
                                          <%--  <asp:Label ID="Label1" runat="server" Text='<%# ShortString2(Eval("OrgIntro").ToString()) %>'></asp:Label>--%>
                                             <%# ShortString2(Eval("OrgNumbers").ToString())%>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# ShortString2(Eval("OrgNumbers").ToString()) %>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
