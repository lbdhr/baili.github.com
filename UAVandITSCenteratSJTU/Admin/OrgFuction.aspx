<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrgFuction.aspx.cs" Inherits="Admin_OrgFuction" %>
                        ...
                        <div id="GridViewShow"> 
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="部门职能" SortExpression="OrgFuction">
                                        <ItemTemplate>
                                          <%--  <asp:Label ID="Label1" runat="server" Text='<%# ShortString2(Eval("OrgIntro").ToString()) %>'></asp:Label>--%>
                                             <%# ShortString2(Eval("OrgFuction").ToString())%>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# ShortString2(Eval("OrgFuction").ToString()) %>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
